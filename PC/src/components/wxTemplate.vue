...
<script>
import { GetMessageTemplateId,UpdateMessageTemplateId } from "@/api/Service";
export default {
  props: {
    RegisteredEdit: {},
    required: true
  ...
  methods: {
    ...
    submitForm() {
      ...
      const para = {
        "UpdateMessageTemplateIdList":newlist
      };
      console.log(para);
      console.log(JSON.stringify(para));
      //return false;
      UpdateMessageTemplateId(para).then(res => {
