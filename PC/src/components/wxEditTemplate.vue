<template>
  <div>
    <Form class="formStyle" ref="child">
      <div class="form_box">
        ...
        <div class="formStyle_list example">
          ...
          <span v-html="MenberDialogForm.Example"></span>
        </div>
        <div class="formStyle_list">
          <div class="f-l">
            <Label for="Code" class="f-l"><span class="br-box">first</span></Label>
            <TextBox inputId="Code" name="Code"   v-model="MenberDialogForm.TopContent"></TextBox>
          </div>
        </div>
        <div class="formStyle_list">
          <div class="f-l">
            <Label for="Code" class="f-l"><span class="br-box">remark</span></Label>
            <TextBox inputId="Code" name="Code" v-model="MenberDialogForm.BottomContent"></TextBox>
          </div>
        </div>
        <div class="formStyle_list">
          <div class="f-l">
            <Label for="Code" class="f-l"><span class="br-box">消息连接</span></Label>
            <TextBox inputId="Code" name="Code"   v-model="MenberDialogForm.Url"></TextBox>
          </div>
        </div>
      </div>
      <div class="f-r mt-30 mb-30">
...
<script>
import { GetMessageTemplateById,UpdateMessageTemplate } from "@/api/Service";
export default {
  props: {
    RegisteredEdit: {},
    required: true
  ...
  methods: {
    ...
    submitForm() {
      ...
      //return false;
      UpdateMessageTemplate(para).then(res => {
    ...
    getInit() {
      ...
      console.log(para);
      GetMessageTemplateById(para).then(res => {
          console.log(res.Result);   
          if(res && res.Result && res.Result.Code == 0){
