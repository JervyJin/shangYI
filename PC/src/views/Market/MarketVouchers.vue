<template>
  <div class="container">
    ...
    >
      ...
      <GridColumn field="MraketingAward" title="营销奖励" align="center">
         <template slot="body" slot-scope="scope">
          <div align="left">{{scope.row.MraketingAward}}</div>
        </template>
      </GridColumn>
    </DataGrid>
    <!-- 分页 -->
...
<script>
import ComboAddCom from "@/components/MarketVouchersSet";
import { parseTime } from "@/utils/index";
import {
  GetCouponUserMarketings,
...
export default {
  ...
  methods: {
    ...
    getCostSaelMarketingsFn() {
      ...
      console.log(para);
      GetCouponUserMarketings(para).then(res => {
        console.log(res.Result);
