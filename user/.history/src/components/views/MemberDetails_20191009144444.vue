          ...
          <van-col span="24" class="mt-20">
            ...
            <van-col span="7">
              <router-link :to="'/StickTag/'+id">
                <div class="Alabel f-12">+ 贴标签<span class="s-1"></span></div>
              </router-link>
            </van-col>
          </van-col>
...
        top: 5px;
————————————————
版权声明：本文为CSDN博主「致年」的原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/u014100996/article/details/49594029
}
</style>
