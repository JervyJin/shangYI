<template>
  <div class="content">
    ...
    <div class="container">
      ...
      <van-cell-group>
        <van-field v-model="info.Address" label="详细地址" input-align="right" type="textarea" placeholder="请输入详细地址" rows="1" autosize/>
      </van-cell-group>
      <van-cell-group>
        <van-field v-model="info.Remark" label="备注" input-align="right" type="textarea" placeholder="请输入备注" rows="1" autosize/>
      </van-cell-group>
      <div class="pd-20">
