<template>
  <div class="content" id="member_details">
    ...
    <div class="container">
      <van-row class="user-links">
        ...
        <van-col span="17">
          ...
          <van-col span="24" class="mt-10 tag_list">
            <p class="c-blue f-12">
              <span
    ...
    <div class="container mt-0">
      <van-cell-group class="user-group">
        <van-cell :value="userInfo.CouponNum" title="优惠券" class="border-bottom">
          <template>
            <i class="iconfont mr-5 f-16" slot="icon" style="color:#FCC27E">&#xe621;</i>
          </template>
        </van-cell>
        <van-cell icon="records" title="套餐" :value="userInfo.ComboNum">
          <template>
